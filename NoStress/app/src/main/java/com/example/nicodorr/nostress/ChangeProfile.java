...
public class ChangeProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ints = new Intent(getApplicationContext(), Profile.class);
                startActivity(ints);
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_GALLERY){
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(ChangeProfile.this, "You don't have permission to access file location", Toast.LENGTH_LONG).show();
            }
            return;
        }
    ...
    private void init(){
        ...
        edtPrice = (EditText) findViewById(R.id.edt2);
        btnCho = (Button) findViewById(R.id.btnChoose);
        btnAd = (Button) findViewById(R.id.btnAdd);
        btnLis = (Button) findViewById(R.id.btnList);
